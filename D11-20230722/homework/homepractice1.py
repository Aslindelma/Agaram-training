"""This task will explain to analyses the data to find the month with min and 
max gold rate along with the total cost of each jewel for the months with the min 
and max god rates."""
